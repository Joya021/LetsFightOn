...
[CreateAssetMenu(menuName = "Validation/SpecificVariableNameRule")]
public class SpecificVariableNameRule : ValidationRule
{
    ...
    public override bool Validate(string editableInput)
    {
        ...
        {
            case "before":
                errorMessages.Add("» Local variables must be declared inside the function. Try initializing the variable inside the function.");
                break;

            case "after":
                errorMessages.Add("» Local variables must be declared before using them. Try initializing the variable before \"print(Message)");
                break;

            case "between":
                ValidateVariableDefinition(trimmedInput, "Inside function: ");
                break;
