...
[CreateAssetMenu(menuName = "Validation/SpecificVariableYRule")]
public class SpecificVariableYRule : ValidationRule
{
    [Tooltip("Require the variable name to be 'y'.")]
    public string targetVariableName = "y";
    ...
    public override bool Validate(string playerInput)
    {
        ...
        {
            errorMessages.Add("» You didn’t enter anything. Try defining a variable named 'y'.");
            return false;
        }
        ...
        switch (context)
        {
            ...
            case "after":
                errorMessages.Add("» You cannot place your answer after the locked code. Define your variable before it.");
                break;
