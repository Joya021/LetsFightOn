...
public class OfflineIntercom : MonoBehaviour
{
    ...
    [Header("References")]
    public OfflineCodeCheckGame codeCheckGame;
    public OfflineGameManager gameManager; // Reference to check if game ended
